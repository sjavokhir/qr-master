package uz.javokhir.kqr.master.ui.localization

object AppStrings {
    const val appName = "KQR Master"
    ...
    const val egPlaceholderSubject = "e.g. KQR Master app"
    ...
    const val permissionsGrantedDescription =
        "You now have complete access to our KQR Master app. Get ready to scan generate and share QR codes with ease."
    ...
    const val shareDescription = "KQR Master - Your all-in-one QR scanner and creator app for quick and effortless code scanning creation and customization. Unlock a world of information with a simple scan and easily generate personalized codes. Get KQR Master now!"
